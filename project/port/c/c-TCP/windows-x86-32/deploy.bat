...
rem ​
rem lib.exe /def:libs\libiotmakers-3rdparty-interface.def /out:libs\libiotmakers-3rdparty-interface.lib /machine:x86
rem 

copy libs\*.lib           %IM_PROJECT_HOME%\samples\c\c-TCP\windows-x86-32\
