...
EXPORT int __stdcall ImAuthSystem(int sess_hndl, char *im_chn_id,	char *im_chn_pw, char *im_sys_id);

EXPORT int __stdcall ImPoll(int hndl);
EXPORT int __stdcall ImMSleep(int hndl, int msec);

EXPORT int __stdcall ImSetTlsCaFile(int hndl, char *ca_file);
EXPORT int __stdcall ImSetTlsCaPath(int hndl, char *ca_path);
...
/////////////////////////////////////////
// System API
EXPORT int __stdcall ImSysResourceSendNotification(int sess_hndl, char *resource_id, char *properties_in_json);
EXPORT int __stdcall ImSysResourceNotificationInit(int sess_hndl);
EXPORT int __stdcall ImSysResourceNotificationAppendResource(int sess_hndl, char *resource_id, char *properties_in_json);
EXPORT int __stdcall ImSysResourceNotificationSend(int sess_hndl);
