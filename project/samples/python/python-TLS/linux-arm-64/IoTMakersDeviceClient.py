...
class IoTMakersDeviceClient:
	...
	def ImInit(self, logLevel=1):
		...
		print('IoTMakersDeviceClient hndl=', self.hndl)
		return self.hndl;
	...
	def ImSetTlsCaFile(self, ca_file_pem):
		return client.ImSetTlsCaFile(self.hndl, ca_file_pem);

	def ImSetTlsCaPath(self, ca_path):
		return client.ImSetTlsCaPath(self.hndl, ca_path);
